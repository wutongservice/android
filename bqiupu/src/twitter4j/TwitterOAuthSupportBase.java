...
abstract class TwitterOAuthSupportBase extends TwitterBase implements HttpResponseCode, HttpResponseListener, OAuthSupport, java.io.Serializable {
    ...
    protected WeakReference<AccountListener> alistener;
    ...
    public void attachAccountListener(AccountListener listener) {
    	alistener = new WeakReference<AccountListener>(listener);
    }
