...
public class BookmarkUtils {
    ...
    public static  enum BookmarkIconType {
     ...
     */
    public static Bitmap createIcon(Context context, Bitmap touchIcon, Bitmap favicon,
            BookmarkIconType type) {
//        final ActivityManager am = (ActivityManager) context
//                .getSystemService(Context.ACTIVITY_SERVICE);
        final int iconDimension = getLauncherLargeIconSize(context);
        final int iconDensity = context.getResources().getDisplayMetrics().densityDpi;;
