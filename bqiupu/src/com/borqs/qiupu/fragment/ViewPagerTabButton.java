...
//	private int mLineColor = 0xFF6F8FC7;
	private int mLineColor = 0xFF378cff;
//	private int mLineColorSelected = 0xFF6F8FC7;
	private int mLineColorSelected = 0xFF378cff;
	
	private int mLineHeight = 2;
	private int mLineHeightSelected = 5;
	...
	public ViewPagerTabButton(Context context, AttributeSet attrs) {
		this(context, attrs, R.style.bottom_tab_btn_style);
	}
	
	public ViewPagerTabButton(Context context, AttributeSet attrs, boolean isSecondTab) {
        this(context, attrs, isSecondTab ? R.style.second_title_textview : R.style.bottom_tab_btn_style);
        mIsSecondTab = isSecondTab;
    } 
