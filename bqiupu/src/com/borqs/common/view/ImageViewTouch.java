...
public class ImageViewTouch extends BaseImageViewTouch {
	...
	protected ImageViewTouchListener imageViewTouchListener;
	...
	public void setImageViewTouchListener(
			ImageViewTouchListener imageViewTouchListener) {
		this.imageViewTouchListener = imageViewTouchListener;
	}
	...
	protected void onZoom( float scale ) {
		super.onZoom( scale );
		if ( mScaleDetector==null || !mScaleDetector.isInProgress() ) mCurrentScaleFactor = scale;
	}
	...
	public class GestureListener extends GestureDetector.SimpleOnGestureListener {
		...
		public boolean onSingleTapConfirmed(MotionEvent e) {
			if(imageViewTouchListener != null) {
				imageViewTouchListener.onSingleTapConfirmed();
			}
