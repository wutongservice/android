...
public class MyTouchListener implements OnTouchListener {  
 ...
 public boolean onTouch(View v, MotionEvent event) {  
  ...
  case MotionEvent.ACTION_POINTER_UP:  
	  if (mode == ZOOM) { 
//		  if (new_dist > 10f) { 
//			  Log.v("wgl", "********oldDist*******"+oldDist+"******************");
//		     Log.v("wgl", "********new_dist*******"+new_dist+"******************");
//			  float new_scale = new_dist / oldDist;
//			  Log.v("wgl", "********new_scale*******"+new_scale+"******************");
//			  float temp_scale = old_scale*new_scale;
//			  Log.v("wgl", "********old_scale*******"+old_scale+"******************");
//			  if (temp_scale < 0.5) {  
//				  matrix.set(savedMatrix);  
//				  float scale = (float)0.5 / old_scale;  
//				  old_scale = old_scale*scale;
//				  Log.v("wgl", "*****还原***scale*******"+scale+"******************");
//				  Log.v("wgl", "*****还原***old_scale*******"+old_scale+"******************");
