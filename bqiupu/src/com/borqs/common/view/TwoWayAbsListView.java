 ...
 *
 * @attr ref android.R.styleable#JessAbsListView_Selector
...
ViewTreeObserver.OnTouchModeChangeListener {
	...
	public TwoWayAbsListView(Context context, AttributeSet attrs, int defStyle) {
		...
		Drawable d = a.getDrawable(R.styleable.TwoWayAbsListView_Selector);
		if (d != null) {
			setSelector(d);
		}
...
//	//}
	 ...
	 *        in the recycler.
	 *
	 * @see com.borqs.common.view.TwoWayAbsListView.RecycleBin
	 * @see com.borqs.common.view.TwoWayAbsListView.RecyclerListener
	 */
	 ...
	 *
	 * @see com.borqs.common.view.TwoWayAbsListView.RecycleBin
	 * @see com.borqs.common.view.TwoWayAbsListView#setRecyclerListener(com.borqs.common.view.TwoWayAbsListView.RecyclerListener)
	 */
	...
	abstract class TouchHandler {
		...
		/**
		 * Fires an "on scroll state changed" event to the registered
		 * {@link com.borqs.common.view.TwoWayAbsListView.OnScrollListener}, if any. The state change
		 * is fired only if the specified state is different from the previously known state.
		 *
		 * @param newState The new scroll state.
		 */
