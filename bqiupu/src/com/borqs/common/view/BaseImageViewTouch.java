...
import com.borqs.common.util.Cubic;
import com.borqs.common.util.Easing;
import com.borqs.common.util.FastBitmapDrawable;
import com.borqs.common.util.IDisposable;
 ...
 * 
 */
public class BaseImageViewTouch extends ImageView implements IDisposable {
	...
	public BaseImageViewTouch( Context context ) {
		super( context );
		init();
	}

	public BaseImageViewTouch( Context context, AttributeSet attrs ) {
		super( context, attrs );
		init();
	}
