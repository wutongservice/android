...
public class Cling extends FrameLayout {
    public interface ClingHolder {
        public void getClingHitRect(Rect r);
        public void getDefaultDisplayMetrics(DisplayMetrics metrics);
    }
    ...
    public void init(ClingHolder l, int[] positionData) {
        if (!mIsInitialized) {
            mHolder = l;
...
//            Folder f = mHolder.getWorkspace().getOpenFolder();
//            if (f != null) {
                Rect r = new Rect();
                mHolder.getClingHitRect(r);
...
//            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (mIsInitialized) {
            ...
            mHolder.getDefaultDisplayMetrics(metrics);
            ...
            // Draw the background
            if (mBackground == null && mDrawIdentifier != null) {
                if (mDrawIdentifier.equals(WORKSPACE_PORTRAIT) ||
                    mDrawIdentifier.equals(WORKSPACE_LANDSCAPE)) {
