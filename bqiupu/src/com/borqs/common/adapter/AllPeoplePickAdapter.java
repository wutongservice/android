...
import com.borqs.common.view.AllPeoplePickItemView;
 ...
 */
public class AllPeoplePickAdapter extends BaseAdapter {
    ...
    public AllPeoplePickAdapter(Context context, Cursor cursor, Cursor extraCursor) {
        mContext = context;
        orm = QiupuORM.getInstance(mContext);
        resetData(cursor, extraCursor);
    }

    public AllPeoplePickAdapter(Context context) {
        mContext = context;
        orm = QiupuORM.getInstance(mContext);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (di != null) {
            AllPeoplePickItemView v;
            if (convertView == null || false == (convertView instanceof AllPeoplePickItemView)) {
                holder = new ViewHolder();
                v = new AllPeoplePickItemView(mContext, di);
                holder.view = v;
                v.setTag(holder);
            } else {
    ...
    static class ViewHolder {
        public AllPeoplePickItemView view;
    }
