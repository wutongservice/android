...
public class Notification {
	...
	public static final String AUTHORITY = "com.borqs.qiupu.provider.inforprovider";
	public static final int ntf_type_request = 100;
	public static final int ntf_type_tome = 102;
	public static final int ntf_type_other = 103;
